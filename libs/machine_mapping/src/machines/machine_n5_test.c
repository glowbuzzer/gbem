...
/**
 ******************************************************************************
 * @file           :  machine_n5_test.c
 * @brief          :  machine map for nanotec n5 drive test
 ******************************************************************************
 * @attention
 *
...
MAP_SLAVE_STANDARD_SDO_FUNCTIONS(         ec_standard_sdos_n5               );
MAP_SLAVE_INITIAL_PDO_FUNCTIONS(          ec_initial_pdo_n5                 );
MAP_SLAVE_DC_TYPE(                        EC_DC_0,                          );
MAP_SLAVE_DC_CYCLE(                       4                                 );


/* DRIVES */
MAP_DRIVE_TO_NAME(                          "N51"                           );
MAP_DRIVE_TO_SLAVE(                         MAP_N5_1                        );
MAP_DRIVE_TO_SUBDRIVE(                      1                               );
MAP_DRIVE_GET_MOO_PDO_FUNCTIONS(            ec_get_moo_pdo_n5               );
MAP_DRIVE_GET_MOO_SDO_FUNCTIONS(            NULL                            );
MAP_DRIVE_GET_REMOTE_FUNCTIONS(             ec_get_remote_n5                );
MAP_DRIVE_GET_FOLLOW_ERROR_FUNCTIONS(       ec_get_follow_error_n5          );
MAP_DRIVE_GET_ERROR_STRING_PDO_FUNCTIONS(   NULL                            );
MAP_DRIVE_GET_ERROR_STRING_SDO_FUNCTIONS(   ec_get_error_string_sdo_n5      );
MAP_DRIVE_SET_CTRL_WRD_FUNCTIONS(           ec_set_ctrl_wrd_n5              );
MAP_DRIVE_GET_STAT_WRD_FUNCTIONS(           ec_get_stat_wrd_n5              );
MAP_DRIVE_GET_ACTPOS_WRD_FUNCTIONS(         ec_get_actpos_wrd_n5            );
MAP_DRIVE_SET_SETPOS_WRD_FUNCTIONS(         ec_set_setpos_wrd_n5            );
...
MAP_DRIVE_PRINT_PARAMS_FUNCTIONS(           ec_print_params_n5              );
