...
/* DRIVES */
MAP_DRIVE_TO_NAME(                          "VIRTUAL J1",                         "VIRTUAL J2",                        "VIRTUAL J3",                         "VIRTUAL J4",                             "VIRTUAL J5",                         "VIRTUAL J6",                           );
MAP_DRIVE_TO_SLAVE(                         0,                                    0,                                   MAP_AW_J32_CTRL_1,                    0,                                        0,                                    0,                                      );
MAP_DRIVE_TO_SUBDRIVE(                      1,                                    1,                                   1,                                    1,                                        1,                                    1,                                      );
MAP_DRIVE_GET_MOO_PDO_FUNCTIONS(            ec_get_moo_pdo_virtual,               ec_get_moo_pdo_virtual,              ec_get_moo_pdo_aw_j_series,           ec_get_moo_pdo_virtual,                   ec_get_moo_pdo_virtual,               ec_get_moo_pdo_virtual,                 );
MAP_DRIVE_GET_MOO_SDO_FUNCTIONS(            NULL,                                 NULL,                                NULL,                                 NULL,                                     NULL,                                 NULL,                                   );
MAP_DRIVE_GET_REMOTE_FUNCTIONS(             ec_get_remote_virtual,                ec_get_remote_virtual,               ec_get_remote_aw_j_series,            ec_get_remote_virtual,                    ec_get_remote_virtual,                ec_get_remote_virtual,                  );
MAP_DRIVE_GET_FOLLOW_ERROR_FUNCTIONS(       ec_get_follow_error_virtual,          ec_get_follow_error_virtual,         ec_get_follow_error_aw_j_series,      ec_get_follow_error_virtual,              ec_get_follow_error_virtual,          ec_get_follow_error_virtual,            );
MAP_DRIVE_GET_ERROR_STRING_PDO_FUNCTIONS(   ec_get_error_string_pdo_virtual,      ec_get_error_string_pdo_virtual,     ec_get_error_string_pdo_aw_j_series,  ec_get_error_string_pdo_virtual,          ec_get_error_string_pdo_virtual,      ec_get_error_string_pdo_virtual,        );
MAP_DRIVE_GET_ERROR_STRING_SDO_FUNCTIONS(   NULL,                                 NULL,                                NULL,                                 NULL,                                     NULL,                                 NULL,                                   );
MAP_DRIVE_SET_CTRL_WRD_FUNCTIONS(           ec_set_ctrl_wrd_virtual,              ec_set_ctrl_wrd_virtual,             ec_set_ctrl_wrd_aw_j_series,          ec_set_ctrl_wrd_virtual,                  ec_set_ctrl_wrd_virtual,              ec_set_ctrl_wrd_virtual,                );
MAP_DRIVE_GET_STAT_WRD_FUNCTIONS(           ec_get_stat_wrd_virtual,              ec_get_stat_wrd_virtual,             ec_get_stat_wrd_aw_j_series,          ec_get_stat_wrd_virtual,                  ec_get_stat_wrd_virtual,              ec_get_stat_wrd_virtual,                );
MAP_DRIVE_GET_ACTPOS_WRD_FUNCTIONS(         ec_get_actpos_wrd_virtual,            ec_get_actpos_wrd_virtual,           ec_get_actpos_wrd_aw_j_series,        ec_get_actpos_wrd_virtual,                ec_get_actpos_wrd_virtual,            ec_get_actpos_wrd_virtual,              );
MAP_DRIVE_SET_SETPOS_WRD_FUNCTIONS(         ec_set_setpos_wrd_virtual,            ec_set_setpos_wrd_virtual,           ec_set_setpos_wrd_aw_j_series,        ec_set_setpos_wrd_virtual,                ec_set_setpos_wrd_virtual,            ec_set_setpos_wrd_virtual,              );
MAP_DRIVE_GET_ACTVEL_WRD_FUNCTIONS(         ec_get_actvel_wrd_virtual,            ec_get_actvel_wrd_virtual,           ec_get_actvel_wrd_aw_j_series,        ec_get_actvel_wrd_virtual,                ec_get_actvel_wrd_virtual,            ec_get_actvel_wrd_virtual,              );
MAP_DRIVE_GET_ACTTORQ_WRD_FUNCTIONS(        ec_get_acttorq_wrd_virtual,           ec_get_acttorq_wrd_virtual,          ec_get_acttorq_wrd_aw_j_series,       ec_get_acttorq_wrd_virtual,               ec_get_acttorq_wrd_virtual,           ec_get_acttorq_wrd_virtual,             );
MAP_DRIVE_GET_CONTROL_EFFORT_WRD_FUNCTIONS( ec_get_control_effort_wrd_virtual,    ec_get_control_effort_wrd_virtual,   ec_get_control_effort_wrd_aw_j_series,ec_get_control_effort_wrd_virtual,        ec_get_control_effort_wrd_virtual, ec_get_control_effort_wrd_virtual          );
MAP_DRIVE_SET_SETVEL_WRD_FUNCTIONS(         ec_set_setvel_wrd_virtual,            ec_set_setvel_wrd_virtual,           NULL,                                 ec_set_setvel_wrd_virtual,                ec_set_setvel_wrd_virtual,            ec_set_setvel_wrd_virtual,              );
MAP_DRIVE_SET_SETTORQ_WRD_FUNCTIONS(        ec_set_settorq_wrd_virtual,           ec_set_settorq_wrd_virtual,          ec_set_settorq_wrd_aw_j_series,       ec_set_settorq_wrd_virtual,               ec_set_settorq_wrd_virtual,           ec_set_settorq_wrd_virtual,             );
MAP_DRIVE_SET_SETTORQOFFSET_WRD_FUNCTIONS(  ec_set_settorqoffset_wrd_virtual,     ec_set_settorqoffset_wrd_virtual,    ec_set_settorqoffset_wrd_aw_j_series, ec_set_settorqoffset_wrd_virtual,         ec_set_settorqoffset_wrd_virtual,     ec_set_settorqoffset_wrd_virtual,       );
MAP_DRIVE_SET_SETVELOFFSET_WRD_FUNCTIONS(   ec_set_setveloffset_wrd_virtual,      ec_set_setveloffset_wrd_virtual,     ec_set_setveloffset_wrd_aw_j_series,  ec_set_setveloffset_wrd_virtual,          ec_set_setveloffset_wrd_virtual,      ec_set_setveloffset_wrd_virtual,        );
MAP_DRIVE_MOO_SET_PDO_FUNCTIONS(            ec_set_moo_pdo_virtual,               ec_set_moo_pdo_virtual,              ec_set_moo_pdo_aw_j_series,           ec_set_moo_pdo_virtual,                   ec_set_moo_pdo_virtual,             ec_set_moo_pdo_virtual,                   );
MAP_DRIVE_HOMING_EXEC_FUNCTIONS(            NULL,                                 NULL,                                NULL,                                 NULL,                                     NULL,                                 NULL,                                   );
MAP_DRIVE_RUN_HOMING(                       0,                                    0,                                   0,                                    0,                                        0,                                    0                                       );
MAP_DRIVE_GET_SECONDARY_NAME_FUNCTION(      NULL,                                 NULL,                                ec_get_secondary_name_aw_j_series,    NULL,                                     NULL,                                 NULL,                                   );
MAP_DRIVE_PRINT_PARAMS_FUNCTIONS(           NULL,                                 NULL,                                ec_print_params_aw_j_series,          NULL,                                     NULL,                                 NULL,                                   );
MAP_DRIVE_TYPE(                             DRIVE_TYPE_VIRTUAL,                   DRIVE_TYPE_VIRTUAL,                  DRIVE_TYPE_AW_J32,                    DRIVE_TYPE_VIRTUAL,                       DRIVE_TYPE_VIRTUAL,                   DRIVE_TYPE_VIRTUAL,                     );
MAP_DRIVE_GET_LOG_FILE_FUNCTIONS(           NULL,                                 NULL,                                ec_get_log_file_aw_j_series,          NULL,                                     NULL,                                 NULL,                                   );
