...
/* DRIVES */
MAP_DRIVE_TO_NAME(                          "AW_J17",                               "VIRTUAL1",                         "VIRTUAL2",                         "VIRTUAL3",                         "VIRTUAL4",                         "VIRTUAL5"                            );
MAP_DRIVE_TO_SLAVE(                         MAP_AW_J17_CTRL,                        0,                                  0,                                  0,                                  0,                                  0,                                  );
MAP_DRIVE_TO_SUBDRIVE(                      1,                                      1,                                  1,                                  1,                                  1,                                  1,                                  );
MAP_DRIVE_GET_MOO_PDO_FUNCTIONS(            ec_get_moo_pdo_aw_j_series,             NULL,                               NULL,                               NULL,                               NULL,                               NULL,                               );
MAP_DRIVE_GET_MOO_SDO_FUNCTIONS(            NULL,                                   ec_get_moo_pdo_virtual,             ec_get_moo_pdo_virtual,             ec_get_moo_pdo_virtual,             ec_get_moo_pdo_virtual,             ec_get_moo_pdo_virtual,             );
