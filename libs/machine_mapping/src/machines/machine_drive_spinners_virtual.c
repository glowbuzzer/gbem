...
MAP_DRIVE_SET_SETPOS_WRD_FUNCTIONS(         ec_set_setpos_wrd_azdxa_ked,        ec_set_setpos_wrd_azdxa_ked,        ec_set_setpos_wrd_virtual,          ec_set_setpos_wrd_virtual,          ec_set_setpos_wrd_virtual,          ec_set_setpos_wrd_virtual,          );
...
/* DRIVE PARAMETERS */
MAP_DRIVE_POS_LIMIT(                        999,                                999,                                0,                                  0,                                  0,                                  0, );
MAP_DRIVE_NEG_LIMIT(                        -999,                               -999,                               0,                                  0,                                  0,                                  0, );
